    ...
    for (var i = 0; i < arr.length; i++) {
        ...
        htmlContent +=
            ...
            <div class="card cardPhone">
                <img src="${phone.img}" class="card-img-top" alt="link hình ảnh">
                <div class="card-body">
                    <div class="d-flex justify-content-between">
                        ...
                        <div>
                            <h3 class="cardPhone__title">${new Intl.NumberFormat('en-US').format(phone.price)}</h3>
...
domID('#filterProduct').onchange = function () {
    ...
    promise
        .then(function (result) {
            ...
            if (domID('#filterProduct').value === 'Iphone') {
                arrFilter = phone.filter(value => value.type === 'Iphone');
...
function renderGioHang(arr) {
    ...
    for (var i = 0; i < arr.length; i++) {
        ...
        <div class="row no-gutters">
            ...
            <div class="col-md-6">
                <div class="card-body p-0">
                    ...
                    <h5 class="font-weight-bold mb-3">${new Intl.NumberFormat('en-US').format(phone.price)}</h5>
        ...
        <div class="modal-body d-flex justify-content-between pb-0">
            ...
            <div class="text-right">
                <h5 class="cardPhone__title mb-0">${new Intl.NumberFormat('en-US').format(phone.quantity * phone.price)}</h5>
            </div>
        </div>
    </div>`
    }
    ...
    // Tính tiền:
    domID('#tamTinh').innerHTML = new Intl.NumberFormat('en-US').format(tinhTienTamTinh());
    domID('#phiVanChuyen').innerHTML = new Intl.NumberFormat('en-US').format(tinhTienGiaoHang());
    domID('#tongTien').innerHTML = new Intl.NumberFormat('en-US').format(tinhTienTongTien(tinhTienTamTinh(), tinhTienGiaoHang()));
